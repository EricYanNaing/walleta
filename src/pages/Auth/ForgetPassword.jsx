...
const ForgetPassword = () => {
  ...
  return (
    <>
      ...
      <div className="!overflow-hidden auth-page-wrapper min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-purple-500 via-pink-500 to-indigo-600">
        {/* Decorative Elements */}
