...
const RegisterUser = () => {
  ...
  const {
    ...
    autoSaveKey: "walleta-register-draft",
    autoSaveFields: ["email", "username"],
  });
  const formatDraftLabel = () => {
    if (!draftSavedAt) return "Username & email drafts save locally.";
  ...
  return (
    <>
      ...
      <div className="auth-page-wrapper min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-purple-500 via-pink-500 to-indigo-600 !overflow-hidden">
        {/* Decorative Elements */}
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full !pl-[42px] pr-4 py-3 bg-white/60 border rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 text-gray-700 ${inputTone("email")}`}
                      value={values.email}
                    />
                  </div>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full !pl-[42px] pr-4 py-3 bg-white/60 border rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 text-gray-700 ${inputTone("username")}`}
