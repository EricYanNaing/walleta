...
const Login = () => {
  ...
  const {
    ...
    autoSaveKey: "walleta-login-draft",
    autoSaveFields: ["username"],
  });
  const formatDraftLabel = () => {
    if (!draftSavedAt) return "Drafts save locally as you type.";
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onBlur={handleBlur}
                      className={`w-full !pl-[38px] sm:!pl-[42px] pr-10 sm:pr-12 py-2.5 sm:py-3 text-sm sm:text-base bg-white/60 border rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 text-gray-700 ${inputTone("password")}`}
